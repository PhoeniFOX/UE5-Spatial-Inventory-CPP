...
AInventoryProjectCppProjectile::AInventoryProjectCppProjectile() 
{
	...
	CollisionComp->OnComponentHit.AddDynamic(this, &AInventoryProjectCppProjectile::OnHit);		// set up a notification for when this component hits something blocking
